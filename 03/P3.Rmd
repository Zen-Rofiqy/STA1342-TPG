...
require("knitr")
opts_knit$set(root.dir = "C:/Users/Fathan/Documents/Obsidian Vault/2. Kuliah/Smt 5/5. Teknik Peubah Ganda/03")
```
...
plot(ellipse(cov_m,centre=xbar,level = 0.50, t=sqrt(((n-1)*p/(n*(n-p)))*qf(0.50,p,n-p))),type="l",main = "Ellips Kepercayaan 50%")
points(xbar[1],xbar[2])
...
Ketika alfanya membesar. Berarti selangnya mengecil.
